...
def _score_finnhub(articles):
    ...
    return {
        ...
        "source": "Finnhub",
        "raw_score": total,
        "score": round(total * DAMPENING_FINNHUB, 1),
...
def _score_newsapi(ticker, articles):
    ...
    return {
        ...
        "source": "NewsAPI",
        "raw_score": total,
        "score": round(total * DAMPENING_NEWS, 1),
        "confidence": "medium",
...
def _score_edgar(filings):
    ...
    return {
        "catalyst_type": cat,
        "headline": f.get("title", "SEC 8-K today"),
        "source": "SEC EDGAR",
        "raw_score": score,
        "score": round(score * DAMPENING_EDGAR, 1),
        "confidence": "high",
        "url": f.get("url", ""),
        "timestamp": datetime.now(timezone.utc).isoformat(),
    }
